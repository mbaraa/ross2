<template>
    <div class="main bg-blue-darken-4">
        ...
        <div class="buttons">
        <ContestantCreateTeam class="delete" :contest="contest"/>
        &nbsp;
        <v-btn @click="joinTeam" icon color="warning" class="delete" title="join a team">
            <FontAwesomeIcon class="text-white" :icon="{prefix:'fas', iconName:'users'}"/>
        </v-btn>
        &nbsp;
        <v-btn @click="joinAsTeamless" icon color="success" class="delete" title="join as teamless">
...
import {faUsers, faUserPlus, faUsersSlash} from "@fortawesome/free-solid-svg-icons";
